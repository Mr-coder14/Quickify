...
public class sucessanimation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sucessanimation);
            ...
            public void run() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent = new Intent(sucessanimation.this, MainActivity.class);
